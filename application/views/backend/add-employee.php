      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Pegawai</h3>
                </div>
    ...
    <?php $depvalue = $this->employee_model->getdepartment(); ?>
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/Employees" class="text-white"><i class="" aria-hidden="true"></i>  Daftar Karyawan</a></button>
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/Disciplinary" class="text-white"><i class="" aria-hidden="true"></i>  Daftar Kedisiplinan</a></button>
                    </div>
                </div>
               <div class="row">
                    <div class="col-12">
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="deg" class="form-control custom-select" required>
                                            <option>Pilih Designation</option>
